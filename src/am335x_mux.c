...
static const struct gpio_pad {
	...
	[0] = {
		...
		[ 7] = {(uint32_t*)(0x44e10000+0x964), "p9_17", "eCAP0_in_PWM0_out"},
		...
		[18] = {(uint32_t*)(0x44e10000+0xa1c), "none",  "usb0_drvvbus"},
		[19] = {(uint32_t*)(0x44e10000+0x9b0), "none",  "xdma_event_intr0"},
		[20] = {(uint32_t*)(0x44e10000+0x9b4), "p9_41", "xdma_event_intr1"},
		...
		[29] = {(uint32_t*)(0x44e10000+0x944), "none",  "rmii_ref_clk"},
	...
	[2] = {
		...
		[ 2] = {(uint32_t*)(0x44e10000+0x890), "p8_07", "gpmc_advn_ale"},
		[ 3] = {(uint32_t*)(0x44e10000+0x894), "p8_08", "gpmc_oen_ren"},
		[ 4] = {(uint32_t*)(0x44e10000+0x898), "p8_10", "gpmc_wen"},
		[ 5] = {(uint32_t*)(0x44e10000+0x89c), "p8_09", "gpmc_be0n_cle"},
		...
		[25] = {(uint32_t*)(0x44e10000+0x8ec), "p8_30", "lcd_ac_bias_en"},
	...
	[3] = {
		...
		[13] = {(uint32_t*)(0x44e10000+0xa34), "none",  "usb1_drvvbus"},
		[14] = {(uint32_t*)(0x44e10000+0x990), "p9_31", "mcasp0_aclkx"},
		[15] = {(uint32_t*)(0x44e10000+0x994), "p9_29", "mcasp0_fsx"},
		[16] = {(uint32_t*)(0x44e10000+0x998), "p9_30", "mcasp0_axr0"},
		[17] = {(uint32_t*)(0x44e10000+0x99c), "p9_28", "mcasp0_ahclkr"},
		[18] = {(uint32_t*)(0x44e10000+0x9a0), "none",  "mcasp0_aclkr"},
		[19] = {(uint32_t*)(0x44e10000+0x9a4), "p9_27", "mcasp0_fsr"},
		[20] = {(uint32_t*)(0x44e10000+0x9a8), "none",  "mcasp0_axr1"},
		[21] = {(uint32_t*)(0x44e10000+0x9ac), "p9_25", "mcasp0_ahclkx"},
	},
};
...
static const struct i2c_pad_ctrl {
	...
	[0] = {
		.sda = {3, 16, 0 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP | PAD_CONTROL_SLEWCTRL},
		.scl = {3, 17, 0 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP | PAD_CONTROL_SLEWCTRL},
	},
	[1] = {
/* no more supported on HEIA-FR board due to the extension board...
		.sda = {0,  4, 2 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP | PAD_CONTROL_SLEWCTRL},
		.scl = {0,  5, 2 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP | PAD_CONTROL_SLEWCTRL},
	},
	[2] = {
*/
		.sda = {0, 12, 3 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP | PAD_CONTROL_SLEWCTRL},
		.scl = {0,  3, 2 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP | PAD_CONTROL_SLEWCTRL},
	},
};
...
//		.sdcd   = {0,  6, 5 | PAD_CONTROL_RXACTIVE | PAD_CONTROL_PULLUP},	
		.lines  =  4,
...
void am335x_mux_setup_gpio_pin(
